<%@ Page Title="UserProfile" Language="C#" MasterPageFile="~/UserScreen/User.Master" AutoEventWireup="true" CodeBehind="UserProfile.aspx.cs" Inherits="Library_Management.UserScreen.UserProfile" %>
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-12">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    <asp:TextBox ID="txtContact" CssClass="form-control" placeholder="Contact No." TextMode="Number" runat="server"></asp:TextBox>
                                </div>
                            </div>
                            <div class="col-md-6">
                ...
                <a href="UserHome.aspx"> << Back To Home Screen</a><br />
            </div>
        </div>
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="row">
                            <div class="col">
                                <center>
                                    <img width="100px" src="../images/b2.jpg" />
                                </center>
                            </div>
                        </div>
                        <div class="row">
